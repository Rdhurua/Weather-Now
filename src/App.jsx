...
export default function App() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen  text-white p-6">
      ...
      <div className="flex justify-center w-full">
        <h1 className=" mx-4 font-semibold text-md text-white">Weather Now</h1>
  ...
  <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-6">
    ...
    {/* Weather Icon (separate box) */}
    {weather && (
      <div className="w-full lg:w-1/3 flex justify-center items-center  rounded-2xl p-4">
        <div className="text-center">
          <i className="text-10xl sm:text-8xl">
            {weatherCodes[weather.weathercode]?.icon}
          </i>
        </div>
      </div>
    )}
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-center text-gray-200">
                {weatherCodes[forecast.weathercode[i + 1]]?.label || "Unknown"}
              </p>
            </div>
